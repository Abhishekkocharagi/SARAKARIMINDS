        ...
        return (
            <div className="bg-white border rounded-xl overflow-hidden shadow-sm mt-4 group">
                <div className="p-3 border-b flex justify-between items-center bg-gray-50">
                    <span className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Sponsored</span>
                    <span className="text-[10px] font-bold text-blue-600 group-hover:underline cursor-pointer">Ad</span>
                </div>
                <div className="p-4">
                    <img
                        src={ad.imageUrl}
        ...
        <div className="bg-white border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
            <div className="px-5 py-3 border-b flex justify-between items-center bg-gray-50/50">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-[10px] font-black uppercase text-gray-500 tracking-[0.2em]">Promoted</span>
                </div>
